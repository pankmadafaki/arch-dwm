...
set -g IFS \n\ \t
export STARSHIP_CONFIG=/home/lr0n/.config/starship.toml
...
#eval /home/lr0n/anaconda3/bin/conda "shell.fish" $argv 'activate' | source
...
#eval /home/lr0n/anaconda3/bin/conda "shell.fish" "hook" $argv | source
# <<< conda initialize <<<
